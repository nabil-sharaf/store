            ...
            <div class="row align-items-center">
                <div class="col-lg-12 m-auto">
                    <div class="page-title-content text-center">
                        ...
                        <div class="bread-crumbs"><a href="{{ route('home.index') }}"> الرئيسية </a><span class="breadcrumb-sep"> / </span><span class="active"> {{$category->name}}</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="shop-toolbar-wrap mb-4">
                        ...
                        <div id="filterContent" class="filter-content mt-3">
                            <form action="{{ route('category.filter',$category->id) }}" method="get">
                ...
                <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="column-three" role="tabpanel" aria-labelledby="column-three-tab">
                            <div class="row">
                                ...
                                @empty
                                    @if(session()->has('filteredProducts'))
                                    <div class="text-center"> لا يوجد منتجات متاحة بالخيارات التي حددتها </div>
                                   @else
                                    <div class="text-center"> لا يوجد منتجات حاليا بهذا القسم </div>
                                    @endif
