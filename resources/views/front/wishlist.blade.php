            ...
            <div class="row align-items-center">
                <div class="col-lg-12 m-auto">
                    <div class="page-title-content text-center">
                        ...
                        <div class="bread-crumbs"><a href="{{route('home.index')}}"> الرئيسية </a><span class="breadcrumb-sep"> / </span><span class="active"> قائمة الأمنيات</span></div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    @foreach($wishlists as $item)
                                        ...
                                        <tr>
                                            <td class="product-remove">
                                                <a href="#" onclick="removeFromWishlist({{ $item->id }})">×</a>
                                            </td>
                                            <td class="product-thumbnail">
{{--                                                <a href="{{ route('product.show', $item->product->id) }}">--}}
                                                    <img src="{{asset('storage').'/'. $item->product->images()->first()->path }}" alt="Image" style="max-width: 75px">
                                                </a>
                                            </td>
                                            ...
                                            <td class="stock-status">
                                                ...
                                                @else
                                                    <span style="color: red"><i class="fa fa-times"></i> غير متوفر</span>
                                                @endif
                                            </td>
                                            <td class="wishlist-cart">
                                                <a href="{{ route('cart.add', $item->product->id) }}"><strong>أضف للسلة</strong></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                        @endif
