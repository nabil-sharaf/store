    ...
    <div class="card card-info">
        ...
        <form class="form-horizontal" action="{{ route('admin.categories.update', $category->id) }}" method="POST" dir="rtl" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="parent_id" class="col-sm-2 control-label">الكاتيجوري الأب</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="image" class="col-sm-2 control-label">صورة القسم</label>
                    <div class="col-sm-10">
                        @if($category->image)
                            <p> صورة القسم الحالية : </p>
