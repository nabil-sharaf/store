...
@section('content')
    <div class="container mt-4">
        <div class="row mb-3">
            <div class="col">
                <a href="{{ route('admin.moderators.index') }}" class="btn btn-secondary mb-3">العودة إلى قائمة المشرفين</a>
            </div>
        </div>
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-footer d-flex justify-content-between">
                <a href="{{ route('admin.moderators.edit', $admin->id) }}" class="btn btn-primary" id="editAdminBtn">تعديل بيانات المشرف</a>
            </div>
        </div>
    </div>
@endsection
