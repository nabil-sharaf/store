                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.products.index') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/products') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>كل المنتجات</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.products.create') }}"
                               class="nav-link {{ Request::is(app()->getLocale() .'/admin/products/create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>إضافة منتج</p>
                            </a>
                        </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.offers.index') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/offers') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.offers.create') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/offers/create') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>إضافة عرض</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.popup.index') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/offers/popup') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p> pop-up الرئيسية</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.promo-codes.index') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/promo-codes') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>كل البرومو</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.promo-codes.create') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/promo-codes/create') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>إضافة برومو كود</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.reports.index') }}"
                                   class="nav-link {{ Request::is(app()->getLocale() .'/admin/reports') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>تقارير المبيعات</p>
                                </a>
                            </li>
