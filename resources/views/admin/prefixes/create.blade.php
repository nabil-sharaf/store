        ...
        <form class="form-horizontal" action="{{ route('admin.prefixes.store') }}" method="POST"  dir="rtl">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName" placeholder="  ادخل الوصف " name="name" value="{{ old('name') }}" >
                ...
                <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="أدخل وصف باللغة العربية او اتركه فارغا" name="description" value="{{ old('description') }}">
